...
<body style="background-color: #DFFFD8;">
    <div class="d-flex justify-content-center align-items-center vh-100">
        <div class="bg-white p-5 rounded-5 text-secondary shadow">
              ...
              <!--FORMULARIO-->
              <form action="<?= base_url("/Perfil/Cambiar_Email/Procesar")?>" method="post">
                ...
                <div class="text-center fs-1 fw-bold mt-2">Nuevo email</div>
                <!--Inpout Group (para agg imagen)-->
                
                <div class="input-group">
                    <span class="input-group-text bg-white mt-2"><img src="<?= base_url("/iconos/username.png")?>" style="height: 1rem;"></span>
                    <input type="email" name="Nuevo_Email" placeholder="Nuevo email" class=" form-control mt-2" maxlength="100" required>
                </div>
