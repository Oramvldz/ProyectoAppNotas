  ...
  <div class="container-fluid">
    ...
    <div class="container mt-3">            
            <div class="input-group">
                ...
                <input class="form-control bg-white" type="text" placeholder="Titulo" name="Titulo" maxlength="100"  disabled value="<?php echo ($Nota['Titulo']); ?>">
            </div>
            <textarea class="form-control mt-3 bg-white" name="Contenido" cols="30" rows="10" disabled maxlength="1000" ><?php echo ($Nota['Contenido']); ?></textarea>
    </div>
