...
<?php if($mensaje==4): ?>
    ...
    <?php elseif($mensaje==5):?>
      <div class="alert alert-danger alert-dismissible">
            <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
              Email ya registrado en el sistema o credenciales de inicio de sesion invalidas actualizacion no realizada
        </div> 
      ...
      <div class="alert alert-danger alert-dismissible">
            <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
              Credenciales de inicio de sesion invalidas actualizacion no realizada
        </div> 
    <?php endif; ?>
